  ...
  <div class="indicator_card">
    ...
    <div class="indicator_card_list" id="wrap">
      <div id="content" class="content">
        <div class="content_list" @mouseleave="leaveItem()">
          <!-- 卡片* -->
          <div
            class="content_card"
            :class="{ content_card2: whichIndex == index }"
            v-for="(item, index) in cardData.data"
            :key="index"
            @mouseenter="emterItem(index)"
          >
            <div class="content_card_left">
              <div :title="item.name" class="content_card_title">
                {{ item.name }}
              </div>
              <div class="content_card_number">
                {{ String(item.value) || item.percent + item.unit }}
                <span>
                  {{ item.unit }}
                </span>
              </div>
            ...
            <div class="content_card_right">
              ...
              <!-- <div
                v-if="item.unit && String(item.value)"
                class="content_card_unit"
              >
                {{ item.unit }}
              </div> -->
    ...
    .content {
      ...
      .content_list {
        ...
        .content_card {
          ...
          height: 67px;
          //  background: #f2f2f2;
        //  background: linear-gradient(304.17deg, #fdfeff -6.04%, #f4f7fc 85.2%);
        background: linear-gradient(299.63deg, #FDFEFF -5.47%, #F4F7FC 86.59%);
